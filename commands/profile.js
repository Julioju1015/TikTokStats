    ...
    (async () => {
        try 
        {
            ...
            if(user.user.signature == ''){
                ...
                .setFooter("By Julioju#1015", "https://cdn.discordapp.com/app-icons/779968259671457792/184465ca744886f62b39f100b52de9a0.png?")
        ...
        catch (error) 
        {
            ...
            .setColor('#FF0000')
            .setTitle(`Erreur`)
            .addField("Une erreur est survenue.", error)
            .setFooter("By Julioju#1015", "https://cdn.discordapp.com/app-icons/779968259671457792/184465ca744886f62b39f100b52de9a0.png?")
